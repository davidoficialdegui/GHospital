...
public class Farmaceutico {
    ...
    @OneToMany(mappedBy = "farmaceutico", cascade = CascadeType.ALL, orphanRemoval = true)
    ...
    public void prePersist() {
        ...
        if (this.rol == null) this.rol = Paciente.Rol.FARMACEUTICO;
    }
    ...
    public List<Dispensacion> getDispensaciones() { return dispensaciones; }
    public void setDispensaciones(List<Dispensacion> dispensaciones) { this.dispensaciones = dispensaciones; }
}
