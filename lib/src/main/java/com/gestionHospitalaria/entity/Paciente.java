...
public class Paciente {
    ...
    private Double altura; // en metros o cm, según quieras
    ...
    public void prePersist() {
        ...
        if (this.tieneSeguroPrivado == null) {
            this.tieneSeguroPrivado = false;
        }
        if (this.consentimientoProteccionDatos == null) {
            this.consentimientoProteccionDatos = false;
        }
        if (this.consentimientoTratamientoDatos == null) {
            this.consentimientoTratamientoDatos = false;
        }
    }
    ...
    public Boolean getConsentimientoProteccionDatos() {
        return consentimientoProteccionDatos;
    }

    public void setConsentimientoProteccionDatos(Boolean consentimientoProteccionDatos) {
        this.consentimientoProteccionDatos = consentimientoProteccionDatos;
    }

    public Boolean getConsentimientoTratamientoDatos() {
        return consentimientoTratamientoDatos;
    }

    public void setConsentimientoTratamientoDatos(Boolean consentimientoTratamientoDatos) {
        this.consentimientoTratamientoDatos = consentimientoTratamientoDatos;
    }
